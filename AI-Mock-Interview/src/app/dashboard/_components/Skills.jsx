      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700 transform transition-all hover:shadow-blue-900/20 hover:shadow-xl">
          ...
          <button
            type="submit"
            disabled={isPending}
            className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-4 rounded-md mt-6 flex items-center justify-center transition-colors"
          >
            {isPending ? (
              <>
